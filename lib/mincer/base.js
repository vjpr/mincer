...
Base.prototype.precompile = function (files, options, callback) {
  ...
  options.allPathsAreLogical = options.allPathsAreLogical || true;
  ...
  if (options.allPathsAreLogical === true) {
    paths = files;
  } else if (options.cachePaths === false || self.paths_cache.length === 0) {
